...
DATA_DIR = './verbalizer/graph2text/data/webnlg'
OUTPUT_DIR = './verbalizer/graph2text/outputs/test_model'
CHECKPOINT = './verbalizer/graph2text/outputs/t5-base_13881/val_avg_bleu=68.1000-step_count=5.ckpt'
MAX_LENGTH = 384
SEED = 42
